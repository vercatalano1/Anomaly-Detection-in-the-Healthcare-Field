# ============================================================
# CNN AUTOENCODER — VARIAZIONE ARCHITETTURA RISPETTO BASELINE

# SCELTA DELLA LOSS MIGLIORE TRA LE 3 PROVATE

# VARIAZIONE LATENT_DIM
# ============================================================
...
def get_loss_function(
    ...
    if loss_type == "mse":
        ...
        raise ValueError(
            f"Loss non supportata: {loss_type}"
        )
...
def plot_training_history(
    ...
    loss_labels = {
        ...
        "mse_l1": "MSE + L1 Reconstruction Loss"
    }

    ax.set_ylabel(
        loss_labels[loss_type]
    )
...
def run_experiment(loss_type: str) -> None:
    ...
    print(
        f" CNN AUTOENCODER — LOSS: {loss_type.upper()}"
    )
    ...
    out_dir = os.path.join(
        "results",
        f"cnn_autoencoder2_nofc_{loss_type}"
    )
...
if __name__ == "__main__":
    ...
    for loss_type in LOSS_TYPES:
        ...
        print(
            f"STARTING EXPERIMENT: {loss_type.upper()}"
        )
        ...
        print(
            f"COMPLETED EXPERIMENT: {loss_type.upper()}"
        )
